...
class OpenRouterProvider:
    """OpenRouter provider for text generation."""
    ...
    async def generate(
        ...
        headers = {
            ...
            "HTTP-Referer": "https://github.com/harveenkaur282-web/RepoMind-AI",
            "X-Title": "RepoMind AI",
        }
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                raise LLMProviderError(f"Malformed response format from OpenRouter API: {e}") from e
